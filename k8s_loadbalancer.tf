resource "proxmox_vm_qemu" "k8s_loadbalancer" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "sudo bash -c 'echo \"    bind ${var.ip_address_start}.${var.load_balancer_ip}:9000\" >> /etc/haproxy/haproxy.cfg'",
      "sudo bash -c 'echo \"    stats enable\" >> /etc/haproxy/haproxy.cfg'",
      "sudo bash -c 'echo \"    stats uri /stats\" >> /etc/haproxy/haproxy.cfg'",
      ...
      "sudo bash -c 'echo \"    bind ${var.ip_address_start}.${var.load_balancer_ip}:6443\" >> /etc/haproxy/haproxy.cfg'",
